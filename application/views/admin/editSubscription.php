          ...
          <div class="">
            ...
            <div class="row">
              <div class="col-md-12 col-sm-12 col-xs-12">
                <div class="x_panel">
                  <div class="x_title">
                    <h2>Edit Subscription <small>editing existing subscription for users view.</small></h2>
                  ...
                  <div class="x_content">
                    ...
                    <?php echo form_open("admin/Subscription/editSubscription",array('id' => 'form_sub','class'=>'form-horizontal form-label-left' ,'novalidate'=>'novalidate', ));?>
